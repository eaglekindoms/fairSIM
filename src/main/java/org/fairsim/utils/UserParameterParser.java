...
public class UserParameterParser {
    ...
    static private final UserParameterParser _upp = new UserParameterParser(); // the default parser
    ...
    static class ParamEntry {
        ...
        boolean isValid() {
			...
			return typ.equals(String.class);
		}
    ...
    int register(Object obj, Class cls, boolean preregister) {
        ...
        for (Field fld : cls.getDeclaredFields()) {
            ...
            if (up != null) {
                ...
                if (!a.isValid()) {
                    throw new RuntimeException("invalid field declaration" + fld);
                }
