...
public final class Vec2d {
    ...
    public interface Real extends Vec.Real, Size {
         ...
         */
        void paste(Vec2d.Real xIn, int ulx, int uly, boolean zero);
         ...
         */
        void project(Vec3d.Real in, int start, int end);

        /**
         * project (sum along z) a Vec3d into this vector
         */
        void project(Vec3d.Real in);

        /**
         * get slice nr n
         */
        void slice(Vec3d.Real in, int n);
         ...
         */
        void setFrom16bitPixels(short[] in);
    ...
    public interface Cplx extends Vec.Cplx, Size {
         ...
         * Get element x,y
         */
        org.fairsim.linalg.Cplx.Float get(int x, int y);

        /**
         * Set element x,y
         */
        void set(int x, int y, org.fairsim.linalg.Cplx.Float v);

        /**
         * Set element x,y
         */
        void set(int x, int y, org.fairsim.linalg.Cplx.Double v);
         ...
         * @param zero Zero the output vector before paste
         */
        void paste(Vec2d.Cplx xIn, int ulx, int uly, boolean zero);
         ...
         */
        void pasteFreq(Vec2d.Cplx xIn, int xOff, int yOff);

        /**
         * pasteFreq(xIn, 0, 0)
         */
        void pasteFreq(Vec2d.Cplx xIn);
         ...
         */
        void fourierShift(double kx, double ky);
         ...
         * project (sum along z, from start to end) a Vec3d into this vector
         */
        void project(Vec3d.Cplx in, int start, int end);

        /**
         * project (sum along z) a Vec3d into this vector
         */
        void project(Vec3d.Cplx in);

        /**
         * get slice nr n
         */
        void slice(Vec3d.Cplx in, int n);
