...
public class Cplx {
    ...
    static public class Double {
         ...
         */
        public Double(double r, double i) {
            re = r;
            im = i;
        }
         ...
         * Return (1,0)
         */
        public static Cplx.Double one() {
            return new Cplx.Double(1, 0);
        }

        /**
         * Returns (0,0)
         */
        public static Cplx.Double zero() {
            return new Cplx.Double(0, 0);
        }

        /**
         * Returns (0,1)
         */
        public static Cplx.Double i() {
            return new Cplx.Double(0, 1);
        }
    ...
    static public class Float {
         ...
         * Return (1,0)
         */
        public static Cplx.Float one() {
            return new Cplx.Float(1, 0);
        }

        /**
         * Returns (0,0)
         */
        public static Cplx.Float zero() {
            return new Cplx.Float(0, 0);
        }

        /**
         * Returns (0,1)
         */
        public static Cplx.Float i() {
            return new Cplx.Float(0, 1);
        }
